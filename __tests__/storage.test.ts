...
describe('StorageService', () => {
  ...
  describe('initStorage', () => {
    it('should initialize storage directory successfully', async () => {
      ...
      (require('expo-file-system').getInfoAsync as jest.Mock).mockResolvedValue(mockDirInfo);
      (require('expo-file-system').makeDirectoryAsync as jest.Mock).mockResolvedValue(undefined);

      await StorageService.initStorage();

      expect(require('expo-file-system').getInfoAsync).toHaveBeenCalledWith('mock/documents/');
      expect(require('expo-file-system').makeDirectoryAsync).toHaveBeenCalledWith('mock/documents/', {
        intermediates: true
      });
    });
    ...
    it('should not create directory if it already exists', async () => {
      ...
      expect(require('expo-file-system').makeDirectoryAsync).not.toHaveBeenCalled();
    });
  });
  ...
  describe('saveEncryptedFile', () => {
    it('should save encrypted file successfully', async () => {
      ...
      (EncryptionService.encryptFile as jest.Mock).mockResolvedValue(mockEncryptedData);
      (require('expo-file-system').writeAsStringAsync as jest.Mock).mockResolvedValue(undefined);
      ...
      expect(EncryptionService.encryptFile).toHaveBeenCalledWith('fileData', 'encryptionKey');
      expect(require('expo-file-system').writeAsStringAsync).toHaveBeenCalledWith(
  ...
  describe('readEncryptedFile', () => {
    it('should read and decrypt file successfully', async () => {
      ...
      (require('expo-file-system').readAsStringAsync as jest.Mock).mockResolvedValue(mockEncryptedData);
      (EncryptionService.decryptFile as jest.Mock).mockResolvedValue(mockDecryptedData);

      const result = await StorageService.readEncryptedFile('/path/to/file.pdf', 'encryptionKey');

      expect(require('expo-file-system').readAsStringAsync).toHaveBeenCalledWith('/path/to/file.pdf', {
        encoding: require('expo-file-system').EncodingType.Base64
      });
      expect(EncryptionService.decryptFile).toHaveBeenCalledWith(mockEncryptedData, 'encryptionKey');
  ...
  describe('deleteFile', () => {
    it('should delete file and log audit successfully', async () => {
      (require('expo-file-system').deleteAsync as jest.Mock).mockResolvedValue(undefined);
      ...
      expect(require('expo-file-system').deleteAsync).toHaveBeenCalledWith('/path/to/file.pdf');
  ...
  describe('getFileInfo', () => {
    it('should get file info successfully', async () => {
      ...
      (require('expo-file-system').getInfoAsync as jest.Mock).mockResolvedValue(mockFileInfo);

      const result = await StorageService.getFileInfo('/path/to/file.pdf');

      expect(require('expo-file-system').getInfoAsync).toHaveBeenCalledWith('/path/to/file.pdf');
  ...
  describe('listUserFiles', () => {
    it('should list user files successfully', async () => {
      ...
      (require('expo-file-system').readDirectoryAsync as jest.Mock).mockResolvedValue(mockFiles);

      const result = await StorageService.listUserFiles('user123');

      expect(require('expo-file-system').readDirectoryAsync).toHaveBeenCalledWith('mock/documents/');
      expect(result).toEqual([
    ...
    it('should return empty array when no files found', async () => {
      (require('expo-file-system').readDirectoryAsync as jest.Mock).mockResolvedValue([]);
  ...
  describe('moveFile', () => {
    it('should move file successfully', async () => {
      (require('expo-file-system').moveAsync as jest.Mock).mockResolvedValue(undefined);
      (DatabaseService.logAudit as jest.Mock).mockResolvedValue(undefined);

      await StorageService.moveFile('/old/path/file.pdf', '/new/path/file.pdf', 'user123');
  ...
  describe('copyFile', () => {
    it('should copy file successfully', async () => {
      (require('expo-file-system').copyAsync as jest.Mock).mockResolvedValue(undefined);
      (DatabaseService.logAudit as jest.Mock).mockResolvedValue(undefined);

      await StorageService.copyFile('/source/file.pdf', '/dest/file.pdf', 'user123');
